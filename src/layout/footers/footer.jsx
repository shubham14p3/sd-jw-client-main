              ...
              <div className="col-xl-4 col-lg-3 col-md-4 col-sm-6">
                <div className="tp-footer-widget footer-col-1 mb-50">
                  <div className="tp-footer-widget-content">
                    ...
                    <p className="tp-footer-desc">I am a dynamic person with experience in full stack developers and design. Crafting high-quality web applications</p>
                ...
                <div className="tp-footer-widget footer-col-4 mb-50">
                  ...
                  <div className="tp-footer-widget-content">
                    <div className="tp-footer-talk mb-20">
                      ...
                      <h4>  <a href="tel:+918092766575">+(91) 8092766575</a></h4>
                    </div>
                    <div className="tp-footer-contact">
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="mailto:shofy@support.com">shubham14p3@gmail.com</a></p>
                        </div>
                      </div>
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        <div className="tp-footer-contact-icon">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="#" target="_blank">Jamshedpur <br /> Jharkhand,IN 831004</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
